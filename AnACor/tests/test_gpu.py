...
class TestBasic:
    ...
    @pytest.mark.order(6)
    # @pytest.mark.skip(reason="This GPU test is being skipped.")
    def test_GPU(self):
        with warnings.catch_warnings():
            ...
            logger.info(print_out)
            logger.info("It takes {:.5f} seconds to run GPU ray-tracing test".format(t2-t1))
            logger.info("\n")
            logger.info("========test_GPU is done========")
            logger.info("\n")
            # pdb.set_trace()